...
import PortfolioHeader from "@/components/v2/portfolio/PortfolioHeader";
    ...
    >
      <div className="container mx-auto px-6 lg:px-10 py-28 md:py-40">
        ...
        <div className="mt-20 md:mt-28 flex flex-col sm:flex-row items-start sm:items-center gap-6">
          <Link to="/v2/case-studies" className="group inline-flex items-center gap-3 border border-gold/40 hover:border-gold px-7 py-4 transition-all">

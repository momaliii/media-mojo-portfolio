      ...
      <div className="flex flex-col h-full">
        <div className="bg-gradient-to-r from-[#8B5CF6] to-[#0EA5E9] p-5">
          <div className="flex justify-between items-center">
            ...
            <MonitorSmartphone className="w-10 h-10 text-white opacity-75" aria-hidden="true" />
          </div>
        </div>
        <div className="p-6 flex-grow">
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="bg-green-100 rounded-full p-1 mr-2 mt-0.5" aria-hidden="true">
        ...
        <div className="p-6 pt-0">
          <button 
            className="text-[#8B5CF6] hover:underline text-sm font-medium flex items-center hover:text-opacity-80 transition-colors"

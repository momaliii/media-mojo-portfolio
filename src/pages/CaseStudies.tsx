      ...
      <div className="min-h-screen bg-obsidian text-white selection:bg-gold/30">
        ...
        <section className="relative pt-32 md:pt-40 pb-20 border-b border-white/[0.06] grain">
          ...
          <div className="container mx-auto px-6 lg:px-10 relative">
            ...
            >
              <Link to="/" className="group inline-flex items-center gap-2 text-white/60 hover:text-gold transition-colors gold-underline font-mono uppercase text-[0.6875rem] tracking-[0.22em]">
                <ArrowLeft size={14} />
                Back to home
              </Link>
              <a
